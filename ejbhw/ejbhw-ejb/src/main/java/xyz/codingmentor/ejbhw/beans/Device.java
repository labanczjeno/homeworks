...
import xyz.codingmentor.ejbhw.constraint.Apple;
import xyz.codingmentor.ejbhw.constraint.Samsung;
import xyz.codingmentor.ejbhw.constraint.Validate;
...
public class Device implements Serializable {
    ...
    public Device(Manufacturer manufacturer, String type, int price, Color color, int count) {
