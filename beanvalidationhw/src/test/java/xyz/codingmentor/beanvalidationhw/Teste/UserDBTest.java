...
public class UserDBTest {
    ...
    public void editUserTest() {
        ...
        secondUser.setEmail("eszete@gmail.com");
        secondUser.setPhone("06304112345");
        UserEntity modifiedUserEntity = userDB.editUser(secondUser);
        Assert.assertEquals(modifiedUserEntity, secondUser);
    }
